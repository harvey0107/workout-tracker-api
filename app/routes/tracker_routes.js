...
router.get('/tracker/:id', requireToken, (req, res, next) => {
...
// CREATE
// POST /examples
router.post('/tracker', requireToken, (req, res, next) => {
...
router.patch('/tracker/:id', requireToken, removeBlanks, (req, res, next) => {
  ...
  Tracker.findById(req.params.id)
    ...
    .then(tracker => {
      ...
      return tracker.updateOne(req.body.tracker)
    })
...
router.delete('/tracker/:id', requireToken, (req, res, next) => {
  Tracker.findById(req.params.id)
    .then(handle404)
    .then(tracker => {
